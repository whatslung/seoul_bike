  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        preferredSize: Size.fromHeight(60), // 원하는 높이 지정 (ex: 80)
        child: AppBar(
          title: Appbartitle(),
          actions: [
            // Flexible(
      ...
      body: Stack(
        children: [
          Container(color: Color(0xff3D5567)),
          Align(
            alignment: Alignment.topCenter,
            child: Container(
              decoration: BoxDecoration(color: Color(0xff30E291)),
              ...
              children: [
                ...
                Center(
                  child: SizedBox(
                    ...
                    height: 800,
                    child: MainMap(
                      onStationsLoaded: (loadedStations) {
                        setState(() {
